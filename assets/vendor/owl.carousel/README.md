...
```html
<link rel="stylesheet" href="/bower_owl.carousel/dist/assets/owl.carousel.min.css" />
```
...
```html
<script src="/bower_jquery/dist/jquery.js"></script>
<script src="/bower_owl.carousel/dist/owl.carousel.min.js"></script>
```
