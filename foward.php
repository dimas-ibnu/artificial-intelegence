   ...
   <div id="heroCarousel" class="container carousel carousel-fade" data-ride="carousel">
     ...
     <div class="carousel-item active">
       <div class="carousel-container">
         ...
         <h2 class="mt-2">Foward Chaining</h2>
         <div class="foward" style="background-color: white; margin: 3rem; padding: 1rem 5rem; border-radius: 10px">
 ...
 <center>
   ...
   <section id="about" class="contact">
     <div class="container">
       <?php
        if (!isset($penyakit)) {
          echo "<h2 class='pt-4'>Rule yang Di lewati :</h2>";
          if ($s['ifyes'] == "0" && $s['ifno'] == "0") {
